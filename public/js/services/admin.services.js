angular.module('admin.service', [])
    ...
    .factory('cplServices', cplServices)
    .factory('pengumumanServices', pengumumanServices)
    .factory('tentangServices', tentangServices)
    .factory('videoServices', videoServices)
    .factory('pengajarServices', pengajarServices)
    .factory('unsurServices', unsurServices)
    .factory('kurikulumServices', kurikulumServices)
    .factory('prestasiServices', prestasiServices)
    .factory('kegiatanServices', kegiatanServices)
    .factory('arsipServices', arsipServices)
    .factory('lulusanServices', lulusanServices)
    ;
...
function slideServices($http, $q, helperServices, AuthService, pesan) {
    var controller = helperServices.url + 'slider/';
    var service = {};
    service.data = [];
    return {
        get: get,
...
function cplServices($http, $q, helperServices, AuthService, pesan) {
    var controller = helperServices.url + 'cpl/';
    var service = {};
    service.data = [];
    return {
        get: get,
    ...
    function post(param) {
        ...
        $http({
            ...
            (res) => {
                param.id = res.data;
                var item = service.data.unsur.find(x => x.id == param.unsur_id);
                res.data.unsur = item.unsur;
                service.data.cpl.push(res.data);
                def.resolve(res.data);
            },
            (err) => {
                pesan.error(err.data.messages.error);
...
function tentangServices($http, $q, helperServices, AuthService, pesan) {
    var controller = helperServices.url + 'tentang/';
    var service = {};
    service.data = [];
    return {
        get: get,
...
function unsurServices($http, $q, helperServices, AuthService, pesan) {
    var controller = helperServices.url + 'unsur/';
    var service = {};
    service.data = [];
    return {
        post: post
...
function kurikulumServices($http, $q, helperServices, AuthService, pesan) {
    var controller = helperServices.url + 'kurikulum/';
    var service = {};
    service.data = [];
    return {
        get: get,
    ...
    function post(param) {
        ...
        $http({
            ...
            (res) => {
                service.data.matakuliah.push(res.data);
                def.resolve(res.data);
            },
            (err) => {
                pesan.error(err.data.messages.error);
    ...
    function kurikulum(param) {
        var def = $q.defer();
        $http({
            method: 'post',
            url: controller + 'kurikulum',
            data: param,
            headers: AuthService.getHeader()
        }).then(
            (res) => {
...
function prestasiServices($http, $q, helperServices, AuthService, pesan) {
    var controller = helperServices.url + 'prestasi/';
    var service = {};
    service.data = [];
    return {
        get: get,
...
function kegiatanServices($http, $q, helperServices, AuthService, pesan) {
    var controller = helperServices.url + 'kegiatan/';
    var service = {};
    service.data = [];
    return {
        get: get,
...
function arsipServices($http, $q, helperServices, AuthService, pesan) {
    var controller = helperServices.url + 'arsip/';
    var service = {};
    service.data = [];
    return {
        get: get,
...
function lulusanServices($http, $q, helperServices, AuthService, pesan) {
    var controller = helperServices.url + 'lulusan/';
    var service = {};
    service.data = [];
    return {
        get: get,
